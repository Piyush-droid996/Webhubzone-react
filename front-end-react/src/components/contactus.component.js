...
const Contact = () => {
        ...
        <div class="contact-container">
            ...
            <div class="contact-address-box">
                ...
                <div class="address-contactus">
                    ...
                    <div class="address-contents"><a href="mailto:contact@webhubzone.in">contact@webhubzone.in</a>
                    </div>
                </div>
                <div class="address-contactus">
                    <span class="fa-stack"><i class="fa fa-circle fa-stack-2x"></i><i
    ...
    <section id="contact-section">
        <div class="contact-container">
            <div class="formGroup ">
                <form class="SubformGroup " onSubmit={onFormSubmit}>
                    <div class="row mb-3 ">
                        <div class="col-sm-11 col-lg-11 margin_1_em ">
                            <input type="YourName " placeholder="Your Name " class="form-control gray_bg "
                                id="inputEmail3 " onChange={(e)=>{setContactForm(contactForm=>({...contactForm, Name:e.target.value})); }} required />
                        </div>
                        <div class="col-sm-11 col-lg-11 margin_1_em ">
                            <input type="Contact_Number " placeholder="Contact Number "
                                class="form-control gray_bg " id="inputEmail3 " onChange={(e)=>{setContactForm(contactForm=>({...contactForm, Number:e.target.value})); }} required />
                        </div>
                        <div class="col-sm-11 col-lg-11 margin_1_em ">
                            <input type="email " placeholder="Your Email " class="form-control gray_bg "
                                id="inputEmail3 " onChange={(e)=>{setContactForm(contactForm=>({...contactForm, Email:e.target.value})); }} required />
                        </div>
                        <div class="col-sm-11 col-lg-11 margin_1_em ">
                            <input type="Company_Name " placeholder="Company Name " class="form-control gray_bg "
                                id="inputEmail3 " onChange={(e)=>{setContactForm(contactForm=>({...contactForm, Company:e.target.value})); }} required />
                        </div>
                        <div class="choose-services" >
                            ...
                            <div class="answer-form">
                                <ul class="items width48">
                                    <li class=" gray_bg"><input type="checkbox" value="Product Listing" /> Product
                                        Listing
                                    </li>
                                    <li class="gray_bg"><input type="checkbox" value="E-Commerce Accout Management" /> E-Commerce Account Management</li>
                                    <li class=" gray_bg"><input type="checkbox" value="Digital Marketing" /> Digital
                                        Marketing</li>
                                    <li class=" gray_bg"><input type="checkbox" value="Web-Development" /> Web-Development
                                    </li>
                                    <li class=" gray_bg"><input type="checkbox" value="App-Development" /> App-Development
                                    </li>
                                    <li class="gray_bg"><input type="checkbox" value="Payment-Gateway" /> Payment-Gateway
                                    </li>
                                </ul>
                        ...
                        <div class="col-sm-11 col-lg-11 margin_1_em ">
                            <textarea placeholder="Requirement " class="form-control gray_bg "
                                id="exampleFormControlTextarea1 " onChange={(e)=>{setContactForm(contactForm=>({...contactForm, Requirement:e.target.value})); }} rows="3 "></textarea>
                        </div>
